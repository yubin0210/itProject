...
public class MailComponent {
    ...
    private final String host = "smtp.gmail.com";
      ...
      private String serverPw = "lhje mkpb sdwb fjfe";
      ...
      @Value("classpath:mailPaymentForm.html")
      private Resource mailPaymentForm;
      ...
      public int sendPayMentMessage(HashMap<String, Object> param) {
          ...
          String sysdate = (String) param.get("sysdate");
          ...
          try {
             ...
             String tag = "";
             Scanner sc = new Scanner(mailPaymentForm.getFile());
             ...
             String content = String.format(tag, storeName, orderName, sysdate, amount, method);
